...
FILETHPRoom=work/thproom.tmp
FILELUMEN=work/lumen.tmp
TH_JSON=work/th.json
THRoom_JSON=work/throom.json
...
cat ../public_html/sensorlogs/tempHumidityPressureGuestRoom.log | sed "s/[[:space:]],[[:space:]]/,/g" | sed "s/\(....-..-..\)[[:space:]]\([0-9][0-9]:[0-9][0-9]\)/\1T\2:00.000Z/g" > $FILETHPRoom
